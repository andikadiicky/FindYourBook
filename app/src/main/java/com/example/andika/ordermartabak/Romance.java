...
public class Romance extends AppCompatActivity {
    ...
    private String[] bukuDika = new String[]{
            "The Fault In Our Stars","Thirteen Reasons Why","Fifty Shades series"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Romance book lists"); //tampil title

        lvItem = (ListView) findViewById(R.id.list_view);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Romance.this, android.R.layout.simple_list_item_1, android.R.id.text1, bukuDika);
    /*
    Step 2
     ...
     */
        ...
        lvItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Romance.this, "Memilih : "+bukuDika[position], Toast.LENGTH_LONG).show();
